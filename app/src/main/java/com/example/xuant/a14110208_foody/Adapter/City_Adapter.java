...
public class City_Adapter extends BaseAdapter{
    ...
    public City_Adapter(Context context, ArrayList<City> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.item_row_changecity, parent, false);

        txtName = (TextView) view.findViewById(R.id.item_row_changecity_txt);
        isChoose = (ImageView) view.findViewById(R.id.item_row_changecity_isChoose);
